...
public struct CreditNoteXMLTransformer: CreditNoteXMLTransforming, Sendable {
    ...
    private func writeDiscrepancy(_ note: NotaCredito, to writer: inout XMLWriter) {
    ...
    private func write(_ total: CreditNoteMonetaryTotal, to writer: inout XMLWriter) {
    ...
    private func write(_ line: CreditNoteLine, to writer: inout XMLWriter) {
        writer.open("cac:CreditNoteLine")
